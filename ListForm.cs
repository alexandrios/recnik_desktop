...
namespace SRWords
{
    ...
    public partial class ListForm : Form
    {
        ...
        private void ListForm_Load(object sender, EventArgs e)
        {
            ...
            Thread remoteProcess = new Thread(ChangesFromServer);
            remoteProcess.Start();
...
#region методы для реализации notifyIcon 
        ...
        */
        ...
        private List<ScanWord.ChangeInfo> Test()
        {
            List<ScanWord.ChangeInfo> list = new List<ScanWord.ChangeInfo>();

            ScanWord.ChangeInfo info;
            /*
            info = new ScanWord.ChangeInfo(48, "I", "tipka", "клавиша", "ти“пка$C#ж$#.#кла’виша$RV#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "vruće", "горячо;жарко", "вру^ће$C#горячо’$RV#;#жа’рко$RV#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "koktel", "коктейль", "ко‛ктел$C#м$#.#кокте’йль$RV#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "preplanulost", "загар", "препла‛нулост$C#ж$#.#зага’р$RV#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "toaleta", "туалет;уборная", "(#одежда$#)#;#вечерња$CL#~$C#вече’рний$#туале’т$#;#2$D#)#туале’т$RV#(#убо’рная$RV#)#см$#.#клозет$CL#;#~$C#за$CL#даме$CL#(#за$CL#мушкарце$C#)#да’мский$#(#мужско’й$#)#туале’т$#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "benzinska pumpa", "бензоколонка; автозаправка", "бе‛нзи_нска_ пу^мпа$C#ж$#.#бензоколо’нка$RV#,#автозапра’вка$RV#.#"); list.Add(info);
            info = new ScanWord.ChangeInfo(48, "I", "heljdina kaša", "гречневая крупа;гречка", "хе“љдина ка“ша$C#гре’чневая$RV#крупа’$RV#,#гре’чка$RV#.#"); list.Add(info);
            */

            //info = new ScanWord.ChangeInfo(48, "I", "auto-put", "шоссе; автострада", "а‛уто-пу^т$MC#м$#.#шоссе’$RV#,#автостра’да$RV#.#"); list.Add(info);
            //info = new ScanWord.ChangeInfo(48, "I", "autoput", "шоссе; автострада", "а‛утопу^т$C#м$#.#шоссе’$RV#,#автостра’да$RV#.#"); list.Add(info);
            //info = new ScanWord.ChangeInfo(48, "D", "autoput", "шоссе; автострада", "а‛утопу^т$C#м$#.#шоссе’$RV#,#автостра’да$RV#.#"); list.Add(info);

            //info = new ScanWord.ChangeInfo(48, "I", "autoportret", "автопортрет", "аутопо‛ртре_т$C#,#-е’та$MC#м$#.#автопортре’т$RV#.#"); list.Add(info);
        ...
        /// </summary>
        private void ChangesFromServer()
        {
            try
            {
                //List<ScanWord.ChangeInfo> info = Test();
                List<ScanWord.ChangeInfo> info = GetChangesFromServer();
        ...
        /// </summary>
        private List<ScanWord.ChangeInfo> GetChangesFromServer()
        {
